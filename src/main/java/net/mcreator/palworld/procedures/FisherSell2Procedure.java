	...
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(PalworldModItems.FISH_BASS.get())) : false) {
			...
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal((new ItemStack(PalworldModItems.FISH_BASS.get()).getDisplayName().getString() + "" + new java.text.DecimalFormat(" ##\uAC1C").format(count) + "\uB97C \uD310\uB9E4\uD558\uC5EC "
