	...
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(PalworldModItems.FISH_MUSKELLUNGE.get())) : false) {
			...
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal((new ItemStack(PalworldModItems.FISH_MUSKELLUNGE.get()).getDisplayName().getString() + "" + new java.text.DecimalFormat("##\uAC1C").format(count)
