...
public class SneakingSpeedUpProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		if (entity.getData(PalworldModVariables.PLAYER_VARIABLES).Skill_Points > 0 && entity.getData(PalworldModVariables.PLAYER_VARIABLES).Player_Level >= 10 && entity.getData(PalworldModVariables.PLAYER_VARIABLES).SneakingSpeedSkillPoint < 4
			...
			{
				PalworldModVariables.PlayerVariables _vars = entity.getData(PalworldModVariables.PLAYER_VARIABLES);
				_vars.SneakingSpeedSkillPoint = entity.getData(PalworldModVariables.PLAYER_VARIABLES).SneakingSpeedSkillPoint + 1;
				_vars.syncPlayerVariables(entity);
			}
